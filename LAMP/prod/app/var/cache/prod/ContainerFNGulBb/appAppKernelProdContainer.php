...
class appAppKernelProdContainer extends Container
{
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('FAVIAqLdZidWgeQxhCjtv1W83RY4qwNY5ghpzb47cVipuAF0pM4pXs6fwHjDMkhh'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'database_host' => '0l7.h.filess.io',
            'database_port' => '3307',
            'database_name' => 'prestashop_pigonlyadd',
            'database_user' => 'prestashop_pigonlyadd',
            'database_password' => 'a123e01686401bf6966f3cb3463c1779a3fdf29d',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'FAVIAqLdZidWgeQxhCjtv1W83RY4qwNY5ghpzb47cVipuAF0pM4pXs6fwHjDMkhh',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-03-11',
            'locale' => 'en-US',
            'use_debug_toolbar' => true,
            'cookie_key' => 'qvcQP31Z9AMnZupA4FKrKH2DQbtPMvU3AAe1VIL86EBFibFSGFR2qWNFmQUmY9ij',
            'cookie_iv' => '3CKJTirxKyKV6pqpP4r3w5z575VagZrF',
            'new_cookie_key' => 'def00000b45e83a55c84d1f4d9f4ae505c190735634c96c459e195660c0c9e3ea4f6400970053ca3ae70407c669fcefd58d6d68ed9bf9a49298ae9568b35d146c5daad25',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAlqAxkusaeBg73ssaj2/e'."\n".'pBW/ztWRiEVNErNI5927Z/Rm36FXNp4f+YqvUrWXii+MHCFMoNlZHvxVp14wOdMa'."\n".'0zaruVXZzLCPZudRub3tpHjVzBwhnGRDB62NadSLxDEa7yYV17DNEWEijP353cNH'."\n".'gNat+mXUXb3Yht/hgAEkOgcQrtDo10tGt42EkS3DHnz4c/kuUhkU2QGz3BRdHYiA'."\n".'70LHAw64RMEGoumLwIXsJ0rBtSzqVnuWHoZqfDfHIUiECDbwvk3zg4lBzmD9aklb'."\n".'FQzIO36nyvSuYzsulZmWA8jzwPPnpxs3iLDhM3NCXzFdVp0bIdxAnzrMuf8k4qdV'."\n".'owIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvwIBADANBgkqhkiG9w0BAQEFAASCBKkwggSlAgEAAoIBAQCWoDGS6xp4GDve'."\n".'yxqPb96kFb/O1ZGIRU0Ss0jn3btn9GbfoVc2nh/5iq9StZeKL4wcIUyg2Vke/FWn'."\n".'XjA50xrTNqu5VdnMsI9m51G5ve2keNXMHCGcZEMHrY1p1IvEMRrvJhXXsM0RYSKM'."\n".'/fndw0eA1q36ZdRdvdiG3+GAASQ6BxCu0OjXS0a3jYSRLcMefPhz+S5SGRTZAbPc'."\n".'FF0diIDvQscDDrhEwQai6YvAhewnSsG1LOpWe5Yehmp8N8chSIQINvC+TfODiUHO'."\n".'YP1qSVsVDMg7fqfK9K5jOy6VmZYDyPPA8+enGzeIsOEzc0JfMV1WnRsh3ECfOsy5'."\n".'/yTip1WjAgMBAAECggEAD83yNay2g8hjK87a1BcUYNopXI37LbW7zw0BxtZ0rgUu'."\n".'cCORL5lq2HetSrvkEStJA8CYtj3oBIDMifmvjLmyVFwlq5Yu+rPB8DWwVRFxKHNH'."\n".'V5nSCwNYJyuWLXcQTT8ryNERtKaH9d1fzzRs7dBqJcIg0ieyHz3mxMwj8JbuEqp2'."\n".'0QJQPyr6eo989aqosUjwbgT+QxKUFeGjcjJe3GlCSLTuwIxy6JmbRZYNHw4nHQXE'."\n".'pc/i3CvyJ5zUfxbNu957BLdA2t2eOudk8Lx0c5LoH7WVsZl7SctCsflDGu3Qnf7A'."\n".'mkQG4cU4kqf3R18/mOg+6fnbn3LweGWAuzLK0yL3VQKBgQDRswzhxSDKYdfLm/N4'."\n".'tfsZLZmZp03MwUoqgSGEBBvW2Qq73IsnjgRcTIqdA/rDVK3er2lao+8qJvi/XeAm'."\n".'979YE42FfmZkOfP6RMcFLGrFoIT+HWLSxWNolaiAuhBw2LCj/380m2fFt7nt1nJC'."\n".'Z0W+JZOHe+btkSTie3QdHMTl7QKBgQC34heO6uG8ekTrkF8579O6pNMD2Mul5ARm'."\n".'klUcHkc+JRCe0SRf0A02pLloeAiOd8fEdIREU6Rwv6ffgG1yrnhK+mdHxEVCd1T9'."\n".'+DqjydDSE7qvI45edUmgmA8XzVFIUaGMwOSCSMUiQ5uKA26GyONrb6BnPf8BvG0s'."\n".'WqsLuMm3zwKBgQCLOPwJfO5bT4CNHtoTv4aZXcwH1qrxkTbjZ15QHsY461qUBUWi'."\n".'GkjM2siAnJ7FRpg1K3KgCg0EiGFH9FSYqo2wNTMVeSkTy+Iuu7ECv02YLg1+BRaS'."\n".'Zxir3AjGhkHaGhOUnlHfJHpOK7/WpzSu34/PQXVkUx+rhFzfvSUHGw2itQKBgQC2'."\n".'dew2bi8MHK8ip6E2FhmcDE0udgKtW3JabT1yp0C+E31IefKD+CgEXrNzTBgBdi2N'."\n".'bKiKPAzhq+thxUfVEfZfP9UXy1OGPm7hi1x0hZ9ltRn7C2cLp4olhn0De0H6ZrXM'."\n".'uuKDvL2P4FIIQpt7tv6i7qLVjxjomhYiet1axkOy1QKBgQCIk1qf7Ujho8usT7jM'."\n".'v+GzMRCpenpVZEzzwDTzdE3jBDoOmGRytmemJaBgzR9J0mHFJ14tFVZ5ntEs+cvg'."\n".'Nurn3Iyc/+/URwmK0ynG8BOX4iSA9zarhyyDcyX0A/S26fOtrc6x6AsEVOf0s+u5'."\n".'bxAODhmZv+6q2JUhwXNiNPywKw=='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                22 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                ...
                31 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                ...
                42 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                ...
                48 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
            ...
            'kernel.secret' => 'FAVIAqLdZidWgeQxhCjtv1W83RY4qwNY5ghpzb47cVipuAF0pM4pXs6fwHjDMkhh',
