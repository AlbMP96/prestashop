...
class appAppKernelProdContainer extends Container
{
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('MOucGGL2hrSqTuJt7XfKS4aucdefk5BO6BkMOtZBQs755AT4eqRqs6YdDQBPjuT6'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'MOucGGL2hrSqTuJt7XfKS4aucdefk5BO6BkMOtZBQs755AT4eqRqs6YdDQBPjuT6',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-03-11',
            'locale' => 'en-US',
            'use_debug_toolbar' => true,
            'cookie_key' => 'vQ3XVzIWpO7TbqkKQZbjLay0oGQdPZJgQQfQofe2Bq482K7yxxFgih939cBtrNgo',
            'cookie_iv' => 'GIhGWsvp75jEtA13ShIkJw4PThRRwNem',
            'new_cookie_key' => 'def00000a408a7f4295f8baba5b6321f18f5921e800e57f7d1b8d31e8f0be1b828155ddee492c82c6be75705259e93d8e50266e5230eaf7560ddd4ec890cea74f857fbc6',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEApSUn+tRezZYQDuTwatrp'."\n".'UNuHT14X5yzaoMRwj5/42K0v5wDWtj8gbq+ZP2On51aKaRhOC3LobvZ+SLoqQZRx'."\n".'7nng5j/kBKAI9CSRomYHdiKQxuBR8hvQWtalW/H0wiqPU+PsVWd6rW4FJenyVyXx'."\n".'vIVYUB6bFt5zGwbq5xMcfICuvZ9hGmyv266P4QjT/6bilvWs/f8p5y5nH6yjrAqz'."\n".'4WYUUEQFLe68Cd1z8M0d2sfhuGRHD6Ie1hzCMMoZi4A4NWkXTbsdszcz8YvPccnY'."\n".'ZafPpTpqV3VCO3yWc1Xv/DPToDH4gUEyLnpbKSyGUNgsPCbx2iRTvMtitYZVJbsi'."\n".'lwIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQClJSf61F7NlhAO'."\n".'5PBq2ulQ24dPXhfnLNqgxHCPn/jYrS/nANa2PyBur5k/Y6fnVoppGE4Lcuhu9n5I'."\n".'uipBlHHueeDmP+QEoAj0JJGiZgd2IpDG4FHyG9Ba1qVb8fTCKo9T4+xVZ3qtbgUl'."\n".'6fJXJfG8hVhQHpsW3nMbBurnExx8gK69n2EabK/bro/hCNP/puKW9az9/ynnLmcf'."\n".'rKOsCrPhZhRQRAUt7rwJ3XPwzR3ax+G4ZEcPoh7WHMIwyhmLgDg1aRdNux2zNzPx'."\n".'i89xydhlp8+lOmpXdUI7