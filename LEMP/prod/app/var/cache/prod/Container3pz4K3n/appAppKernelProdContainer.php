...
class appAppKernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '44f.h.filess.io', 'port' => '3307', 'dbname' => 'prestashop_warndrawby', 'user' => 'prestashop_warndrawby', 'password' => '4c1d83cf61e9537096e4ac4fdb37e77e13ce786f', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3xX7vHXnt57LZy8sZcuuOgSyajswe0V4ZzSY40PcXgN0bafRj0ztBFj5eJznAfpN'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'database_host' => '44f.h.filess.io',
            'database_port' => '3307',
            'database_name' => 'prestashop_warndrawby',
            'database_user' => 'prestashop_warndrawby',
            'database_password' => '4c1d83cf61e9537096e4ac4fdb37e77e13ce786f',
            'database_prefix' => 'ps_',
            ...
            'secret' => '3xX7vHXnt57LZy8sZcuuOgSyajswe0V4ZzSY40PcXgN0bafRj0ztBFj5eJznAfpN',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-03-12',
            'locale' => 'en-US',
            'use_debug_toolbar' => true,
            'cookie_key' => '2oJmtWLNeUWtuL80fz6PUB58JNwTcywFPdm1D3g2cvB5WZsbPsYq9DObAGRoQg7I',
            'cookie_iv' => 'e2Bt4wMDTwrdpMHvhrmUhAupXKxQiCyv',
            'new_cookie_key' => 'def00000a8c0bdeb473ca00dd05c7d4d7852e000ede2752c6b8f944f8771a5d25df07f1d05943056029d61450096c51af1ec750959112d337669c37b80b76b4ef46c56fe',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAs8bMZJEa/gIJpLKD1Yn1'."\n".'M2NwK2azJHpy8FuXDT/XabzTA/bTr1loqbq0LM2aUGkJTMySccWWxVF53Vt2YEb6'."\n".'fjSRaowVuzft2DfsDC0B9fpYoOWbcEIgL8egZxRWLdiYjHX3XdmwQL7uK5oy/p5k'."\n".'Ats12ejP55mTFPdS9xHVHP7ahmCv0obbxinZSF0uJLEH0jRRrNQopavIN35J5y5W'."\n".'kIBrbdo1lVxeUxRPTgBvMiZjJ6i8Ks0zHz9benN1OGqzmujlxXLgnZwCPBo8Q4sq'."\n".'8IoHhRmEDjXFxDQKO1d1uLH8MZ8nOox0/4smyQb7eYwurWDJmRQdHHez/2+aX/LW'."\n".'jQIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
