...
class appAppKernelProdContainer extends Container
{
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('PmFbPB9YhOMPRwUoevdu4H942BEWkzrKgD9QTLDnw1Bz7hhBjfyQ2fGFKoFO6DL8'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'PmFbPB9YhOMPRwUoevdu4H942BEWkzrKgD9QTLDnw1Bz7hhBjfyQ2fGFKoFO6DL8',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-03-11',
            'locale' => 'en-US',
            'use_debug_toolbar' => true,
            'cookie_key' => 'pNadu4AraCINuy9H1YNJOPcedhZMajKYXtcZSq5d3FtjSFsOn5DD4I3jC2vOW7Md',
            'cookie_iv' => 'IiCCyQIZugZZ4WtrqdwXnn5vIZKRja14',
            'new_cookie_key' => 'def00000c76781257f590450b71b458d961af94332a70ead9786f492f6344cc6b0b5833555f78cefbd1cfe02236096b5306e5335e1e57ca8a841c46472b142d3b800f060',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA58h8iZmE3Slixrt0DwSt'."\n".'zVeSZEWYKWrJiiFfs40RSNQLLSAs8NjTsjhEsDVrpaSgWn3udclVgx3aFnUCv/SL'."\n".'6iGNbCDrIyEOERYlrnviZT9h9519VrHB3eTK7Pkl8+VTg2KZpusdLS3eS855Zrml'."\n".'19dzFgvWFHTI0Dtuinlh251fyz4Kf/x4iHhFf/BUgLtCg3vuLVFRwwr1ZA2mGqkA'."\n".'Kxzox+HjKgGjQ+YdhmnC5lVob9iaT9h4ZGWo49By6alkFSNFOknC1HOsjB/Hzk7N'."\n".'1ceAC8Mu8o0bgmQl39Y3u1q4kbvAIQdlIFGnk6wYeUzr4un9g3YJiha28rXM9Cki'."\n".'zQIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQDnyHyJmYTdKWLG'."\n".'u3QPBK3NV5JkRZgpasmKIV+zjRFI1AstICzw2NOyOESwNWulpKBafe51yVWDHdoW'."\n".'dQK/9IvqIY1sIOsjIQ4RFiWue+JlP2H3nX1WscHd5Mrs+SXz5VODYpmm6x0tLd5L'."\n".'znlmuaXX13MWC9YUdMjQO26KeWHbnV/LPgp//HiIeEV/8FSAu0KDe+4tUVHDCvVk'."\n".'DaYaqQArHOjH4eMqAaND5h2GacLmVWhv2JpP2HhkZajj0HLpqWQVI0U6ScLUc6yM'."\n".'H8fOTs3Vx4ALwy7yjRuCZCXf